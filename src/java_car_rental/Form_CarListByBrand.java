 ...
 * @author Ydnek
 */
public class Form_CarListByBrand extends javax.swing.JFrame {

    /**
     * Creates new form Form_CarListByBrand
     */
    
    Car car = new Car();
    ArrayList<Car> carList = car.carsByBrandList(0);
    int  id =0;
    
    public Form_CarListByBrand(int brand_id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Cars List By Brand");
        ...
        Table_Cars.setBackground(new java.awt.Color(255, 255, 255));
        Table_Cars.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 51, 0)));
        Table_Cars.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Table_Cars.setSelectionBackground(new java.awt.Color(153, 153, 153));
        Table_Cars.setSelectionForeground(new java.awt.Color(0, 0, 0));
        ...
        jButton_select_car.setBackground(new java.awt.Color(0, 255, 255));
        jButton_select_car.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton_select_car.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton_select_car, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jButton_select_car, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void Table_CarsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Table_CarsMouseClicked
        ...
        int id = Integer.valueOf(Table_Cars.getValueAt(index,0).toString());
        String fullname = Table_Cars.getValueAt(index,1).toString();

        String phone = Table_Cars.getValueAt(index,3).toString();
        String email = Table_Cars.getValueAt(index,4).toString();
        String address = Table_Cars.getValueAt(index,5).toString();
    ...
    private void jButton_select_carActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_select_carActionPerformed
        ...
        int index  = Table_Cars.getSelectedRow();
        String id  = Table_Cars.getValueAt(index, 0).toString();
        String model = Table_Cars.getValueAt(index, 1).toString();
        String price = Table_Cars.getValueAt(index, 4).toString();

        Form_BookCar.dispalyCarInfo(id, model,price);
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(Form_CarListByBrand.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Form_CarListByBrand(0).setVisible(true);
            }
        });
    }
